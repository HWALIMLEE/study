...
model.add(SimpleRNN(100,input_length=3,input_dim=1)) #input_shape(3,1)==(input_length=3, input_dim=1)/ input_dim=1은 1차원/ batch_size는 덩어리로 자르는 거, feature는 행을 자르는 거 
