...
from keras.layers import Conv1D, MaxPooling1D, BatchNormalization, Activation, Bidirectional
...
LSTM : 한방향으로 작용
LSTM이 양방향으로 작용한다면
(시계열 작업 두번 가능)==Bidirectional
Bidirectional을 wrapping
LSTM wrapping하면 양방향으로 작동
파라미터 두배가 된다
"""
