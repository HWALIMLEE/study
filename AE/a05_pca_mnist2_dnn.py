...
model=Sequential()
model.add(Dense(20,input_shape=(154,)))
...
model.fit(x2_train,y_train,epochs=50,batch_size=50,callbacks=[early_stopping])


#4. 평가, 예측
loss,acc=model.evaluate(x2_test,y_test,batch_size=50)  #loss, metrics에 집어넣은 값
print("loss:",loss)
print("acc:",acc)
...
# 최종값: 0.986
# 최종값(PCA, n_components=154): 0.964