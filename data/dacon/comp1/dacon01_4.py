...
model=Sequential()
model.add(Dense(512,input_shape=(71,),activation='relu'))
...
submission.to_csv("./data/dacon/comp1/sample_submission1_4.csv", header = ["hhb", "hbo2", "ca", "na"], index = True, index_label="id" )
