...
model.fit(x_train,y_train,epochs=100,batch_size=50,callbacks=[early_stopping],validation_split=0.2)

model.save('./model/sample/mnist_model_save.h5')
model.save_weights('/model/sample/mnist_save_weight.h5')
