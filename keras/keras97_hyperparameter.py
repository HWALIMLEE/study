...
def create_hyperparameters():
    ...
    #epoch도 넣을 수 있고, load의 개수, activation도 넣을 수 있다(많이 넣을 수 있다.)
...
search = GridSearchCV(model,hyperparameters, cv=3) # 40000은 train/ 20000은 test/ 마지막 40000은?
search.fit(x_train,y_train)

# GridSearch안에 keras넣기
# GridSearch parameter에 model, parameter, cv 들어가는데 GridSearch는 sklearn이다
