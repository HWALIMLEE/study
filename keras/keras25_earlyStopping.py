...
model.fit([x1_train,x2_train],y1_train,validation_split=0.2,epochs=1000,batch_size=4,verbose=1,callbacks=[early_stopping]) #두 개 이상일떄는 리스트


# 4.평가
# 출력값이 여러개
loss,mse=model.evaluate([x1_test,x2_test],y1_test,batch_size=3) 
print("loss:",loss)
# print("mse:",mse)
