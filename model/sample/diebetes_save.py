...
modelpath='./model/sample/diabetes-{epoch:02d}-{val_loss:.4f}.hdf5' 
...
model.fit(x_train,y_train,epochs=100,batch_size=1,callbacks=[early_stopping,checkpoint],validation_split=0.2)

# model.save('./model/sample/diabetes_model_save.h5')
# model.save_weights('./model/sample/diabetes_save_weights.h5')
