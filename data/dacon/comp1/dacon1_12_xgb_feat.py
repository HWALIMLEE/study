...
model = XGBRegressor(n_estimators=500,learning_rate=0.1,max_depth=7,colsample_bytree=0.7,colsample_bylevel=0.7)
...
for thresh in thresholds: # 컬럼수만큼 돈다(최소한 13번)
    ...
    {"n_estimators":[50,100],"max_depth":[5,6],"colsample_bytree":[0.6,0.9],
    ...
    submission.to_csv("./data/dacon/comp1/sample_submission1_12.csv", header = ["hhb", "hbo2", "ca", "na"], index = True, index_label="id" )
