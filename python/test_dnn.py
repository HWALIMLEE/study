...
input1=Input(shape=(5,)) # 변수명은 소문자(암묵적약속)
...
# 또 레이어 연결(3)
middle1=Dense(10,name='m1')(merge1)
middle1=Dense(15,name='m2')(middle1)
middle1=Dense(10,name='m3')(middle1)
...
model.fit([x_train_scaled,x2_train_scaled],y2_train,epochs=500, batch_size=1,callbacks=[early_stopping,checkpoint],validation_split=0.2)

model.save('./model/test4_dnn.h5')


#4. 훈련, 평가
loss_acc=model.evaluate([x_test_scaled,x2_test_scaled],y_test,batch_size=1)
