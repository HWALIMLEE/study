...
from sklearn.ensemble import RandomForestClassifier, RandomForestRegressor # 랜덤포레스트가 앙상블과 연관이 있다
...
# make_pipeline ---> 모델명 앞에 언급해줄 것, 소문자로 써야 한다. (완전히 소문자여야한다.)
parameters=[
    {"randomforestclassifier__n_estimators":[1,10,100]},                        
    {"randomforestclassifier__max_depth":[1,2,4,8]},
    {"randomforestclassifier__min_samples_split":[1,2,4,8,16]},
...
# best estimator-전체 다 나오는거
# best params- 내가 설정한 것만 나오는 것