...
#3. 훈련
modelpath='./model/sample/cifar100-{epoch:02d}-{val_loss:.4f}.hdf5' 
...
hist=model.fit(x_train,y_train,epochs=10, batch_size=150,validation_split=0.2,callbacks=[early_stopping,checkpoint])
# model.save('./model/sample/cifar100_model_save.h5')
